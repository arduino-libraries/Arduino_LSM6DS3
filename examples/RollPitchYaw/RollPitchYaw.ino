...
void setup() {
  ...
  // this could be 'arduino monitor', 'arduino plotter' or 'processing.org P3D client (see pde file)' 
  while (!Serial);
...
/**
 * This comma separated format is best 'viewed' using 'arduino plotter' or processing.org client (see pde example)
 */
